...
// Array.indexOf()
// Search the array for a specific elemetn and returns its first index, and it will return -1 if the element is not found
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
...
// Array.every()
// Checks if all elements in an array pass a test given as a function. If there is one element that returns a false value, the function returns false and does not check the rest of the elements.
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
...
// Array.slice()
// Selects a parts of an array and returns a new array. Selects the elements starting at the provided start argument and ends at, but does not include the provided end argument.
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
